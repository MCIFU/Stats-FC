...
`equipos.js`, `portada.js`, `ligas.js`, `goles.js`, `nombres.js` y la carpeta `carrera/`.
...
- **Equipos**: clasificación con los últimos 5 (V/E/D; al pasar el ratón se ve el partido y se resaltan los dos equipos), partidos,
  ...
  icono por título, historia, efemérides, entrenadores, colores del club y enlace a sus equipaciones históricas (Football Kit Archive).
- **Ligas**: cada liga tiene su página con clasificación, partidos por jornada con goles, goleadores/asistentes y otras listas,
  equipos y estadios (asistencia media), estadísticas de equipo, traspasos y, en LaLiga y LaLiga2, límite salarial por temporada (2019-20 a 2026-27).
