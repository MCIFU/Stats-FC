const fs = require('fs');
const data = JSON.parse(fs.readFileSync('C:\\Users\\PCGAMI~1\\AppData\\Local\\Temp\\opencode\\bl1_2026.json','utf8'));
let gc={},cs={};
for(const m of data){
  if(!m.matchResults || m.matchResults.length===0) continue;
